...
This file contains a class representing a HexBot environment state. 
You should make use of this class in your solver.
...
class State:
    ...
    def __init__(self,
                 environment,
                 robot_posit: tuple[int, int],
                 robot_orient: str,
                 widget_centres: tuple[tuple[int, int], ...],
                 widget_orients: tuple[str, ...],
                 force_valid=True):
        """
